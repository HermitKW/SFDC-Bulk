...
Above two jar can be found at folder "external library"
...
1. Import data to MDM Oracle Database. Integrate ORM tools to the application.
Hibernate is already imported in this project but the table are not configured.
Please help to complete it or using other tools/method.

2. (Optional) The application used BULK API 1.0. BULK API 2.0 is an alternative way to get data from Salesforce.
They do have pros and cons.